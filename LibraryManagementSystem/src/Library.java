...
class Library implements Serializable {
    ...
    static void saveSysInfo(){
        try (ObjectOutputStream oos_book = new ObjectOutputStream(new FileOutputStream("D:\\javaSEProjects" +
                "\\LibraryManagementSystem\\save\\log_book.txt"));
             ObjectOutputStream oos_reader = new ObjectOutputStream(new FileOutputStream("D:\\javaSEProjects" +
                     "\\LibraryManagementSystem\\save\\log_reader.txt"));
             ObjectOutputStream oos_borrowInfo = new ObjectOutputStream(new FileOutputStream("D:\\javaSEProjects" +
                     "\\LibraryManagementSystem\\save\\log_borrowInfo.txt"))
        ){
